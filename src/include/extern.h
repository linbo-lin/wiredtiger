...
extern int __wt_block_find_prevdiscard(WT_SESSION_IMPL *session, WT_BLOCK_CKPT *ci,
  uint32_t objectid, WT_EXTLIST **el_retp) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
